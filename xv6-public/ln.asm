    ...
    300a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  if(argc != 3){
    ...
    3017:	52                   	push   %edx
    3018:	52                   	push   %edx
    3019:	68 48 37 00 00       	push   $0x3748
    301e:	6a 02                	push   $0x2
    3020:	e8 fb 03 00 00       	call   3420 <printf>
    exit();
  ...
  exit();
    ...
    3049:	68 5b 37 00 00       	push   $0x375b
    304e:	6a 02                	push   $0x2
    3050:	e8 cb 03 00 00       	call   3420 <printf>
    ...
    337c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    33a9:	0f b6 92 d0 37 00 00 	movzbl 0x37d0(%edx),%edx
    ...
    3429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3499:	ff 24 85 78 37 00 00 	jmp    *0x3778(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    35a7:	90                   	nop
          s = "(null)";
    35a8:	ba 6f 37 00 00       	mov    $0x376f,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    35c1:	a1 7c 3a 00 00       	mov    0x3a7c,%eax
{
  ...
  freep = p;
    ...
    3601:	5b                   	pop    %ebx
  freep = p;
    3602:	89 15 7c 3a 00 00    	mov    %edx,0x3a7c
}
    3608:	5e                   	pop    %esi
    3609:	5f                   	pop    %edi
    360a:	5d                   	pop    %ebp
  ...
  freep = p;
    363c:	89 15 7c 3a 00 00    	mov    %edx,0x3a7c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    365c:	8b 3d 7c 3a 00 00    	mov    0x3a7c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    36a1:	8b 3d 7c 3a 00 00    	mov    0x3a7c,%edi
  ...
  return freep;
    36cf:	8b 15 7c 3a 00 00    	mov    0x3a7c,%edx
    ...
    36fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    36ff:	89 15 7c 3a 00 00    	mov    %edx,0x3a7c
}
    ...
    370f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    3710:	c7 05 7c 3a 00 00 80 	movl   $0x3a80,0x3a7c
    3717:	3a 00 00 
    base.s.size = 0;
    371a:	bf 80 3a 00 00       	mov    $0x3a80,%edi
    base.s.ptr = freep = prevp = &base;
    371f:	c7 05 80 3a 00 00 80 	movl   $0x3a80,0x3a80
    3726:	3a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3729:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    372b:	c7 05 84 3a 00 00 00 	movl   $0x0,0x3a84
    3732:	00 00 00 
    if(p->s.size >= nunits){
