...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++)
    ...
    3030:	68 58 37 00 00       	push   $0x3758
    3035:	83 c3 01             	add    $0x1,%ebx
    3038:	50                   	push   %eax
    3039:	68 5a 37 00 00       	push   $0x375a
    303e:	6a 01                	push   $0x1
    3040:	e8 eb 03 00 00       	call   3430 <printf>
    3045:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
    3049:	83 c4 10             	add    $0x10,%esp
    304c:	39 f3                	cmp    %esi,%ebx
    304e:	75 e0                	jne    3030 <main+0x30>
    3050:	68 5f 37 00 00       	push   $0x375f
    3055:	50                   	push   %eax
    3056:	68 5a 37 00 00       	push   $0x375a
    305b:	6a 01                	push   $0x1
    305d:	e8 ce 03 00 00       	call   3430 <printf>
    ...
    338c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    33b9:	0f b6 92 c0 37 00 00 	movzbl 0x37c0(%edx),%edx
    ...
    3439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    34a9:	ff 24 85 68 37 00 00 	jmp    *0x3768(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    35b7:	90                   	nop
          s = "(null)";
    35b8:	ba 61 37 00 00       	mov    $0x3761,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    35d1:	a1 74 3a 00 00       	mov    0x3a74,%eax
{
  ...
  freep = p;
    ...
    3611:	5b                   	pop    %ebx
  freep = p;
    3612:	89 15 74 3a 00 00    	mov    %edx,0x3a74
}
    3618:	5e                   	pop    %esi
    3619:	5f                   	pop    %edi
    361a:	5d                   	pop    %ebp
  ...
  freep = p;
    364c:	89 15 74 3a 00 00    	mov    %edx,0x3a74
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    366c:	8b 3d 74 3a 00 00    	mov    0x3a74,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    36b1:	8b 3d 74 3a 00 00    	mov    0x3a74,%edi
  ...
  return freep;
    36df:	8b 15 74 3a 00 00    	mov    0x3a74,%edx
    ...
    370c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    370f:	89 15 74 3a 00 00    	mov    %edx,0x3a74
}
    ...
    371f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    3720:	c7 05 74 3a 00 00 78 	movl   $0x3a78,0x3a74
    3727:	3a 00 00 
    base.s.size = 0;
    372a:	bf 78 3a 00 00       	mov    $0x3a78,%edi
    base.s.ptr = freep = prevp = &base;
    372f:	c7 05 78 3a 00 00 78 	movl   $0x3a78,0x3a78
    3736:	3a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    373b:	c7 05 7c 3a 00 00 00 	movl   $0x0,0x3a7c
    3742:	00 00 00 
    if(p->s.size >= nunits){
