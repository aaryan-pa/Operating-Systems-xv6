...
main(int argc, char *argv[])
{
  ...
  exit();
    ...
    3050:	50                   	push   %eax
    3051:	ff 33                	push   (%ebx)
    3053:	68 7f 37 00 00       	push   $0x377f
    3058:	6a 02                	push   $0x2
    ...
    339c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    33c9:	0f b6 92 fc 37 00 00 	movzbl 0x37fc(%edx),%edx
    ...
    3449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    34b9:	ff 24 85 a4 37 00 00 	jmp    *0x37a4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    35c7:	90                   	nop
          s = "(null)";
    35c8:	ba 9b 37 00 00       	mov    $0x379b,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    35e1:	a1 b4 3a 00 00       	mov    0x3ab4,%eax
{
  ...
  freep = p;
    ...
    3621:	5b                   	pop    %ebx
  freep = p;
    3622:	89 15 b4 3a 00 00    	mov    %edx,0x3ab4
}
    3628:	5e                   	pop    %esi
    3629:	5f                   	pop    %edi
    362a:	5d                   	pop    %ebp
  ...
  freep = p;
    365c:	89 15 b4 3a 00 00    	mov    %edx,0x3ab4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    367c:	8b 3d b4 3a 00 00    	mov    0x3ab4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    36c1:	8b 3d b4 3a 00 00    	mov    0x3ab4,%edi
  ...
  return freep;
    36ef:	8b 15 b4 3a 00 00    	mov    0x3ab4,%edx
    ...
    371c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    371f:	89 15 b4 3a 00 00    	mov    %edx,0x3ab4
}
    ...
    372f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    3730:	c7 05 b4 3a 00 00 b8 	movl   $0x3ab8,0x3ab4
    3737:	3a 00 00 
    base.s.size = 0;
    373a:	bf b8 3a 00 00       	mov    $0x3ab8,%edi
    base.s.ptr = freep = prevp = &base;
    373f:	c7 05 b8 3a 00 00 b8 	movl   $0x3ab8,0x3ab8
    3746:	3a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    374b:	c7 05 bc 3a 00 00 00 	movl   $0x0,0x3abc
    3752:	00 00 00 
    if(p->s.size >= nunits){
